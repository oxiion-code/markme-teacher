...
class BranchContainer extends StatelessWidget{
  ...
  const BranchContainer({super.key,required this.branch, required this.onEdit, required this.onDelete});
  @override
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child:  Image.asset("assets/images/branch_icon.png",height: 30,width: 30,),
                  ),
